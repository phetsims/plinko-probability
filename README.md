...
(3) Open in the browser: `http://localhost/plinko-probability/build/adapted-from-phet/plinko-probability_en_adapted-from-phet.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
