...
(5) Open in the browser: `http://localhost/plinko-probability/plinko-probability_en.html` (You will probably need to modify this
...
(3) Open in the
browser: `http://localhost/plinko-probability/build/adapted-from-phet/plinko-probability_en_adapted-from-phet.html` (You will
